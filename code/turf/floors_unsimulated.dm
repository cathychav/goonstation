...
/turf/unsimulated/floor/europa
    name = "silicate rock"
    desc = "Europa's surface"
    icon_state = "europa"
    temperature = 130
    oxygen = 0.5 //europa's atmosphere is only made out of oxygen, and it's very tenuous
    fullbright = 0.75

    mat_appearances_to_ignore = list("cerenkite")
    mat_changename = 0
    mat_changedesc = 0
